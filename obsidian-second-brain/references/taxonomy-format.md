...
This is the taxonomy half of #221. The other half - rejecting tag syntax Obsidian silently mangles (digit-only tags, `.` or whitespace in a tag, disallowed characters) - is a write-time check in the historical upstream write hook (not packaged) and `scripts/vault_health.py`, unrelated to this file.
