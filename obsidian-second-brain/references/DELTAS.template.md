...
- [ ] Ran the historical upstream bootstrap helper (not packaged) (or set up the vault by hand)
- [ ] Verified the existing managed entrypoint; no runtime setup unless separately requested
