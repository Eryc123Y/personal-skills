...
> **Codex compatibility:** Read [the scope and routing adapter](../references/codex-command-routing.md) before using this legacy procedure. Follow the current user request and vault `AGENTS.md`; the defaults below do not authorize extra writes, automatic saves, setup, or subagents.
